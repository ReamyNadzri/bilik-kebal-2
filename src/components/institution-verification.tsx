...
export function InstitutionVerification({
  ...
  return (
    <section className="institution-verification">
      ...
      <div className="panel verification-block">
        ...
        <>
          ...
          <div className="panel verification-block">
            ...
            <aside className="privacy-note" role="note" aria-label="How your evidence is handled">
              ...
              <p>
                Your document is stored privately. Only a Sheriff reviewing your request can open
                it. It is never shown on the Wanted Board, attached to a claim, or sent in an email.
                It is deleted 30 days after the decision and any appeal period ends.
              </p>
            </aside>
            ...
            {institutions.length === 0 ? (
              <UiStatus
                ...
                message="No institutions are available for verification yet, so a request cannot be submitted. Try again later."
              />
            ) : (
              <form
                className="auth-form"
